...
class CBLib
{
	protected static $THISCBVERSION		=	'2.1.2+build.2017.07.24.16.34.38.9a00f4248';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	/**
	 * @var Application
	 */
