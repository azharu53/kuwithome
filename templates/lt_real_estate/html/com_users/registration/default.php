	...
	<div class="col-sm-12 col-sm-offset-0">
		<div class="registration<?php echo $this->pageclass_sfx?>">
			...
			<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
				...
				<?php $i =1; foreach ($this->form->getFieldsets() as $fieldset): // Iterate through the form fieldsets and display each one.?>
...
<script>
jQuery('#jform_name').val('<?php echo time(); ?>');
jQuery('#jform_name-lbl').parent().hide();
</script>