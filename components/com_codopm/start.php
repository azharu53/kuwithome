...
<script type="text/javascript">
    (function($) {
        $(window).load(function() {
            ...
            $.get(codopm.path + '/server/codopm.php?do=get_config&id=' + codopm.from + '&xhash=' + codopm.xhash, {}, function(data) {
...
<div id="codopm_tabs" class="codopm_tabs">
    <ul>
        ...
        <li class="active"><a href="#codopm_tab-2" id="codopm_inbox_a"><?php codopm::t('Inbox') ?></a></li>
    ...
    <div class="codopm_tab_content">
        ...
        <div class="codopm_tabs_divs" id="codopm_conversations" style="display:none">
            ...
            <div class="codopm_reply_box" >
                <form enctype="multipart/form-data" method="post" id="codopm_reply_form" action="<?php echo codopm::$path; ?>/server/codopm.php?do=send&id=<?php echo $user->id; ?>&xhash=<?php echo codopm::$xhash; ?>">
