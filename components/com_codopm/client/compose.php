...
<div class="codopm_compose">
    <form enctype="multipart/form-data" method="post" id="codopm_compose" action="<?php echo codopm::$path; ?>/server/codopm.php?do=send&id=<?php echo $user->id; ?>&xhash=<?php echo codopm::$xhash; ?>">
    ...
    (function($) {
        ...
        $("#codopm_to_id").autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON(codopm.path + "server/autocomplete.php", request, function(data, status, xhr) {
