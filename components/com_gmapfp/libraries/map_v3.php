...
//Ajout du logo GMapFP en bas à gauche de la carte
	if ($config->get('gmapfp_logo', 1)) {
		...
		$code_logo = '		function Hide_Google_link'.$num.'() {
				...
				gmapfp_link =  "<a style=\"position: static;overflow: visible;float: none;display: inline;\" title=\"GMapFP: Map Component for Joomla\" target=\"_blank\" href=\"http://gmapfp.org\"><div class=\"gmnoprint\" style=\"width: 60px; height: 24px; cursor: pointer; \"><img style=\"position: absolute; left: 0px; top: 24px; -webkit-user-select: none; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; border-image: initial; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; width: 60px; height: 24px; \" src=\"'.$logo_img.'\"></div></a>";
