...
$document->addStyleSheet(JUri::root() . 'media/com_propertycontact/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_propertycontact&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="inquiry-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PROPERTYCONTACT_TITLE_INQUIRY', true)); ?>
		<div class="row-fluid">
